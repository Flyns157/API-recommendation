...
class Database:
    ...
    def create_user(self, username:str, password:str):
        ...
        if self.NO_AUTH:
            ...
            # TODO : Adapt this next query to fit the model
            query = "CREATE (u:users {username: $username, password: $password})"
    ...
    def find_user_by_username(self, username:str):
        if  self.NO_AUTH:
            ...
            # TODO : Adapt this next query to fit the model
            query = "MATCH (u:users {username: $username}) RETURN u.username AS username, u.password AS password"
            with self.driver.session() as session:
